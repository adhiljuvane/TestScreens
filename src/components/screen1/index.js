...
const steps = [{
  ...
  content:
    ...
    <div style={{width : "350px" , display : "flex" , flexDirection : "row" , alignItems : "center" ,paddingRight : "30px", justifyContent : "flex-end"}}>
      <div style={{padding : "20px"}}>Name</div>
      <Input style={{width : "200px"}} placeholder="Basic usage" />
    </div>
    <div style={{width : "90%" , display : "flex" , flexDirection : "row" , alignItems : "center" ,paddingRight : "50px", justifyContent : "flex-end"}}>
      <div style={{padding : "20px" , paddingRight : "-10px"}}>Email</div>
      <InputGroup compact style={{paddingLeft : "-20px"}}>
        <Select defaultValue="Zhejiang">
          <Option value="Zhejiang">Zhejiang</Option>
          <Option value="Jiangsu">Jiangsu</Option>
        </Select>
        <Input style={{width : "210px"}} defaultValue="Xihu District, Hangzhou" />
      </InputGroup>
    </div>
    <div style={{width : "350px" , display : "flex" , flexDirection : "row" , alignItems : "center" ,paddingRight : "30px", justifyContent : "flex-end"}}>
